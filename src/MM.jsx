            ...
            {leadTab==='connector'&&<div>
              ...
              {cLeads.length===0
                ...
                return(<div key={l.id} style={{background:'#fff',border:'1px solid #e2e8f0',borderLeft:'4px solid '+C.blue,borderRadius:'12px',padding:'14px',marginBottom:'10px',boxShadow:'0 1px 4px rgba(0,0,0,0.04)'}}>
                  {l.project_name&&<div style={{marginBottom:'6px'}}><span style={{background:'#f1f5f9',color:'#475569',border:'1px solid #e2e8f0',fontSize:'10px',fontWeight:'700',padding:'2px 8px',borderRadius:'10px'}}>📁 {l.project_name}</span></div>}
