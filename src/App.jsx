...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* 앱 아이콘 */}
      <div style={{
        width: '180px', height: '180px', borderRadius: '36px',
        background: 'linear-gradient(145deg,#1a3a6e,#0d2244)',
        ...
        {/* 아이콘 내부 빛 효과 */}
        <div style={{ position:'absolute', top:'10%', left:'10%', width:'80%', height:'80%', borderRadius:'50%', background:'radial-gradient(ellipse,rgba(245,200,80,0.15) 0%,transparent 70%)', pointerEvents:'none' }}/>
        {/* 건물 아이콘 */}
        <div style={{ fontSize: '56px', marginBottom: '4px', filter: 'drop-shadow(0 0 12px rgba(245,158,11,0.5))' }}>🏙️</div>
        <div style={{ fontSize: '13px', fontWeight: '900', color: '#f59e0b', letterSpacing: '1px' }}>상권통</div>
        <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.5)', marginTop: '2px' }}>지역상권 연결 플랫폼</div>
      </div>
