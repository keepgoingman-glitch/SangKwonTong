...
function DupCheckModal({ leads, directLeads, users, onClose }) {
          ...
          : shown.map(g => (
            <div key={g.key} style={{ background: g.cross ? '#fef2f2' : '#fff', border: '1.5px solid ' + (g.cross ? '#fecaca' : '#e2e8f0'), borderRadius: '12px', padding: '12px', marginBottom: '10px' }}>
              ...
              {g.arr.map((x, i) => {
                ...
                return (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '7px 0', borderTop: i > 0 ? '1px solid #f1f5f9' : 'none', fontSize: '12px' }}>
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, color: C.text, fontFamily: "'Noto Sans KR',sans-serif", maxWidth: '480px', margin: '0 auto', display: 'flex', flexDirection: 'column' }}>
      ...
      {showDupCheck && (() => {
        ...
        return <DupCheckModal leads={_dupLeads} directLeads={_dupDirect} users={_dupUsers} onClose={() => setShowDupCheck(false)} />
      })()}
      ...
      <div ref={scrollRef} style={{ flex: 1, overflowY: 'auto', padding: '14px' }}>
        ...
        {tab === 'uturn' && isSuper && (
          <div>
            ...
            <p style={{ fontSize: '12.5px', color: C.sub, margin: '0 0 14px' }}>팀별 UIT 목표·실적을 입력하면 U-TURN 대시보드 게이지·리더보드에 반영됩니다 · <b style={{ color: '#7c3aed' }}>U=신규·MNP(기변 제외)</b></p>
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '10px' }}>
