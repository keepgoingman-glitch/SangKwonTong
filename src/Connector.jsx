              ...
              <div style={{ background: '#fff', border: '1.5px solid #bfdbfe', borderRadius: '14px', padding: '18px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
                ...
                <button onClick={() => {
                  ...
                  for (let mo = _startMonth; mo <= _nowM; mo++) {
                    ...
                    const cl = leads.filter(l=>myUsers.map(u=>u.name).includes(l.assigned_to) && l.activity_status && l.activity_status!=='미처리' && inThis(l.activity_at||l.created_at))
                    const dl = directLeads.filter(l=>myUnames.includes(l.mm_username) && inThis(l.activity_at||l.created_at))
                    const all = [...cl, ...dl]
                    ...
                    ;(isSuper?mDiscovery:mDiscovery.filter(m=>m.team_id===adminInfo?.teamId)).forEach(m=>{
                  ...
                  const annualTargetCalc = perMMTarget * myUsers.length * Math.max(1, _nowM - _startMonth + 1)
