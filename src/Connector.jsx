...
function buildSlideHTML({ period, today, yearStr, teams, projects, allMM, topMM,
  ...
  *{margin:0;padding:0;box-sizing:border-box;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}
  ...
  <div class="body">
    <div style="display:flex;gap:10px;margin-bottom:12px">
      <div style="flex:1;background:#eff6ff;border:1.5px solid #bfdbfe;border-radius:12px;padding:11px;text-align:center"><div style="font-size:22px;font-weight:900;color:#2563eb">${monthData.tot.count}<span style="font-size:12px">건</span></div><div style="font-size:10.5px;color:#64748b">월간 P&S 성공</div></div>
      <div style="flex:1;background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:12px;padding:11px;text-align:center"><div style="font-size:22px;font-weight:900;color:#16a34a">${monthData.tot.total}<span style="font-size:12px">회선</span></div><div style="font-size:10.5px;color:#64748b">월간 수주 회선</div></div>
      <div style="flex:1;background:#faf5ff;border:1.5px solid #e9d5ff;border-radius:12px;padding:11px;text-align:center"><div style="font-size:22px;font-weight:900;color:#7c3aed">${cumData.tot.count}<span style="font-size:12px">건</span></div><div style="font-size:10.5px;color:#64748b">누적 P&S 성공</div></div>
      <div style="flex:1;background:#fff7ed;border:1.5px solid #fed7aa;border-radius:12px;padding:11px;text-align:center"><div style="font-size:22px;font-weight:900;color:#e67e00">${cumData.tot.total}<span style="font-size:12px">회선</span></div><div style="font-size:10.5px;color:#64748b">누적 수주 회선</div></div>
      <div style="flex:1;background:#f1f5f9;border:1.5px solid #cbd5e1;border-radius:12px;padding:11px;text-align:center"><div style="font-size:22px;font-weight:900;color:#475569">${(agenciesList||[]).length}</div><div style="font-size:10.5px;color:#64748b">등록 대리점</div></div>
    </div>
    <div style="margin-bottom:10px">${renderTable(monthData,'▶ 월간 유형별 상품 성과','#15803d')}</div>
