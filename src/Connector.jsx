...
function buildSlideHTML({ period, today, yearStr, teams, projects, allMM, topMM,
  ...
  *{margin:0;padding:0;box-sizing:border-box;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}
  ...
  const TOTAL_PAGES = reportMode==='annual' ? 7 : (9 + MP_PAGES.run + MP_PAGES.done + MP_PAGES.init + 1)
  ...
  // 연간 모드: 표지 + 연간 전용 6장으로 구성 (월간 페이지 미포함)
  const sAnnual = isAnnual
    ? (anSummarySlide(2) + anMonthlySlide(3) + anThemeSlide(4) + annualTeamSlide(5) + annualMMSlide(6) + anMPlusSlide(7))
    : ''
