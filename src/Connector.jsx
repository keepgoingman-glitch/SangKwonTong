...
function buildSlideHTML({ period, today, yearStr, teams, projects, allMM, topMM,
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  ${rh('프로젝트별 종합 현황', (isPast?'월마감 → 누적':'주간 → 월간 → 누적')+' + 상품별 실적 (월간)', 3)}
  ${dbar}
  <div class="body">
    <table>
      <thead>
  ...
  const s4=projDetailSlide(projects[0],4)
  const s5=projDetailSlide(projects[1],5)
  const s6=projDetailSlide(projects[2],6)
  const s7=projDetailSlide(projects[3],7)
  const s8=projDetailSlide(projects[4],8)
