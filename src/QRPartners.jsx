...
const KT_LOGO = 'data:image/png;base64,'
...
const INDUSTRY_TEMPLATES = {
  '무인문구점':{
    icon:'✏️', char:'🧑‍🎓', deco:'✏️', industry:'문구점',
  ...
  '무인의류':{
    icon:'👕', char:'🛍️', deco:'👗', industry:'의류매장',
...
export default function QRPartners({ onBack, embeddedUser }) {
  const [screen, setScreen] = useState(embeddedUser ? 'main' : 'login')
  const [user, setUser] = useState(embeddedUser || null)
  ...
  // embedded(상권통 탭) 진입 시: QR 파트너 자동 등록 + 데이터 로드
  useEffect(()=>{
    ...
    ;(async()=>{
      try {
        let u = { ...embeddedUser }
        const exist = await db.get('qr_partners','select=*&username=eq.'+u.username).catch(()=>[])
        if(exist && exist.length){
          u = { id:exist[0].id, username:exist[0].username, name:exist[0].name, team_id:exist[0].team_id, qr_code:exist[0].qr_code }
        } else {
          const code = 'QRP-'+u.username+'-'+String(Date.now()).slice(-4)
          const newP = { username:u.username, name:u.name, team_id:u.team_id||'', qr_code:code }
  ...
  const login = async ()=>{
    ...
    try {
      ...
      const rows = await db.rpc('verify_qr_login', { p_username: idTrim, p_password: pwTrim }).catch(()=>[])
      let matched = (rows && rows.length) ? rows[0] : null
      if(!matched){ setLerr('아이디 또는 비밀번호가 올바르지 않습니다'); return }
      let u
      if(matched.source === 'qr_partner'){
        u = { id: matched.id, username: matched.username, name: matched.name, team_id: matched.team_id, qr_code: matched.qr_code }
      } else {
        // mm_users 계정 → QR 파트너스 자동 등록
        const code = 'QRP-'+matched.username+'-'+String(Date.now()).slice(-4)
        const newP = { username:matched.username, name:matched.name, team_id:matched.team_id, qr_code:code }
        const res = await db.post('qr_partners', newP).catch(()=>null)
        u = { ...newP, id:(Array.isArray(res)?res[0]?.id:res?.id)||Date.now() }
      }
      // QR 코드 없으면 생성
  ...
  return (
    <div style={{minHeight: embeddedUser ? 'auto' : '100vh',background:C.bg,color:C.text,fontFamily:"'Noto Sans KR',sans-serif",maxWidth:'440px',margin:'0 auto',display:'flex',flexDirection:'column'}}>
      ...
      <div style={{background:'#fff',borderBottom:'1px solid #e2e8f0',boxShadow:'0 2px 8px rgba(0,0,0,0.05)',position:'sticky',top:0,zIndex:50}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'12px 16px 0'}}>
          ...
          <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
            ...
            {!embeddedUser && <button onClick={onBack} style={{background:'none',border:'none',color:C.sub,fontSize:'12px',cursor:'pointer'}}>로그아웃</button>}
          </div>
        </div>
...
function FlyerModal({ store, onClose }){
  ...
  return(
    <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.75)',zIndex:200,display:'flex',flexDirection:'column',alignItems:'center',overflowY:'auto',padding:'16px'}}>
      ...
      {/* ════ A3 전단 (레퍼런스 스타일) ════ */}
      <div id="flyer-print" ref={flyerRef} style={{width:'400px',height:'507px',background:'#fdfcf8',borderRadius:'8px',overflow:'hidden',boxShadow:'0 20px 60px rgba(0,0,0,0.4)',display:'flex',flexDirection:'column',position:'relative',fontFamily:"'Pretendard','Noto Sans KR',sans-serif",backgroundImage:'radial-gradient(circle at 1px 1px,rgba(0,0,0,0.03) 1px,transparent 0)',backgroundSize:'8px 8px'}}>

        {/* 상단 KT × 매장명 */}
        <div style={{padding:'18px 24px 0',display:'flex',alignItems:'center',gap:'9px',position:'relative',zIndex:2}}>
          <img src={KT_LOGO} alt="kt" style={{height:'26px',width:'auto',display:'block'}}/>
          <span style={{fontSize:'16px',color:'#cbd5e1'}}>×</span>
          <span style={{fontSize:'18px',fontWeight:'800',color:tpl.dark}}>{store.store_name}</span>
        </div>

        {/* 말풍선 (우상단) */}
        <div style={{position:'absolute',top:'20px',right:'20px',fontSize:'10px',fontWeight:'700',color:tpl.dark,textAlign:'right',lineHeight:1.4,whiteSpace:'pre-line',zIndex:2}}>{tpl.speech}</div>

        {/* 메인 헤드라인 */}
        <div style={{padding:'14px 24px 0',position:'relative',zIndex:2}}>
          <div style={{fontSize:'36px',fontWeight:'900',color:tpl.main,lineHeight:1,letterSpacing:'-2px'}}>{store.store_name}</div>
          <div style={{fontSize:'22px',fontWeight:'800',color:'#1e293b',lineHeight:1.25,marginTop:'7px',letterSpacing:'-1px',whiteSpace:'pre-line'}}>{tpl.headline}<span style={{color:tpl.headlineHiColor||tpl.accent}}>{tpl.headlineHi}</span></div>
        </div>

        {/* 중단: 빨래방형(말풍선+체크) vs 메모지형 */}
        {tpl.bubble ? (
        ...
        {/* 하단 혜택 띠 */}
        <div style={{background:`linear-gradient(90deg,${tpl.barFrom},${tpl.barTo})`,padding:'12px 18px 13px'}}>
          <div style={{textAlign:'center',fontSize:'12.5px',fontWeight:'900',marginBottom:'8px',color:tpl.barTitle}}>{store.store_name} 고객 전용 혜택</div>
