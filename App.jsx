  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg,#0a1628,#0f1f38)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '30px 24px', fontFamily: "'Noto Sans KR', sans-serif", color: '#f1f5f9' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '100%', maxWidth: '320px' }}>
        <a href="#connector" style={{ display: 'block', background: 'linear-gradient(135deg,#1a2f4a,#0f1f38)', border: '2px solid #f59e0b', borderRadius: '16px', padding: '24px', textDecoration: 'none', textAlign: 'center' }}>
        ...
        <a href="#mm" style={{ display: 'block', background: 'linear-gradient(135deg,#091809,#0c1524)', border: '2px solid #4ade80', borderRadius: '16px', padding: '24px', textDecoration: 'none', textAlign: 'center' }}>
          <div style={{ fontSize: '36px', marginBottom: '10px' }}>🏃</div>
